...
#ifndef VIDEO_SERVICE_SERVER_PEER_CHANNEL_H_
#define VIDEO_SERVICE_SERVER_PEER_CHANNEL_H_
...
class ChannelMember {
 ...
 protected:
  struct QueuedResponse {
    QueuedResponse();
    QueuedResponse(const QueuedResponse&);
    ~QueuedResponse();
...
#endif  // VIDEO_SERVICE_SERVER_PEER_CHANNEL_H_
